...
\definecolor{AlwaysBeBabyToMe}{HTML}{F9F8E7}
\definecolor{Drift}{HTML}{E1E8D9}
\definecolor{Again}{HTML}{C0D9CF}
\definecolor{IAmMagazineSpine}{HTML}{2B2825}
\definecolor{HazySummerEve}{HTML}{3D7079}
\definecolor{ConspiciousCreep}{HTML}{D6156C}
\definecolor{Smak}{HTML}{790800}
\definecolor{TeBeso}{HTML}{FE6C6C}
\definecolor{Zen}{HTML}{DA6D5E}
\definecolor{ConspiciousCreep}{HTML}{D6156C}
\definecolor{Creep}{HTML}{0B8C8F}
\definecolor{CreepyCream}{HTML}{FCF8BC}
\definecolor{CreepySocks}{HTML}{CACF43}
\definecolor{IAmMagazineSpine}{HTML}{2B2825}
\definecolor{DopeBlouse}{HTML}{E2E75B}
\definecolor{CorporateCobalt}{HTML}{44749D}
\definecolor{SoSleepy}{HTML}{EBE7E0}
\definecolor{LightBlue}{HTML}{C6D4E1}
\definecolor{CorporateBay}{HTML}{BDB8AD}
\definecolor{k4}{HTML}{21304D}
\definecolor{Midnight}{HTML}{0B1B3A}
\definecolor{DirtyGreen}{HTML}{CDDA70}
\definecolor{WinterSkin}{HTML}{EFE4CA}
\definecolor{Smak}{HTML}{790800}
\definecolor{YoungFrankenstein}{HTML}{4D4741}
\definecolor{SandwichBread}{HTML}{EEEADD}
\definecolor{Land}{HTML}{D3CCAB}
\definecolor{AppleMeat}{HTML}{FFFFE7}
\definecolor{Zen}{HTML}{DA6D5E}
